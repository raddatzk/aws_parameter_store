...
import '../../../../main.dart';
import 'column_view_cubit.dart';

class ColumnViewService {
  ...
  Future<ContextData> loadDataForBucketIfNeeded(ContextData data, String bucketName) async {
    if (data[bucketName] == null) {
      return loadDataForBucket(data, bucketName);
    }
